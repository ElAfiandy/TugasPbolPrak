...
public class frmsettingdb extends javax.swing.JFrame {
    ...
    public void cekdb(){
        ...
        MainMenu.driver = "com.mysql.jdbc.Driver";
        MainMenu.database ="jdbc:mysql://"+txtserver.getText();
        MainMenu.namadb=txtdatabase.getText();
        MainMenu.user = txtuser.getText();
        MainMenu.pass = txtpassword.getText();
        MainMenu.portdb=txtport.getText(); 
        MainMenu.database=MainMenu.database+':'+MainMenu.portdb+'/'+MainMenu.namadb; 
    }
    ...
    private void initComponents() {
        ...
        txtdatabase.setText("jTextField2");

        txtuser.setText("jTextField3");

        txtpassword.setText("jTextField4");

        txtport.setText("jTextField5");
